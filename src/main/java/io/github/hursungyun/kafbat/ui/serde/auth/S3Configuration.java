...
/**
 * Configuration holder for S3 connection parameters Centralizes S3 configuration parsing and
 * validation
 */
public class S3Configuration {
    ...
    public static S3Configuration fromProperties(PropertyResolver properties, String prefix) {
        ...
        String endpoint =
                properties
                        .getProperty("s3.endpoint", String.class)
        ...
        String bucket =
                properties
                        .getProperty(prefix + ".bucket", String.class)
                        .orElseThrow(
                                () -> new IllegalArgumentException(prefix + ".bucket is required"));
        String objectKey =
                properties
                        .getProperty(prefix + ".object.key", String.class)
                        .orElseThrow(
                                () ->
                                        new IllegalArgumentException(
                                                prefix + ".object.key is required"));
        Duration refreshInterval =
                properties
                        .getProperty(prefix + ".refresh.interval.seconds", Long.class)
